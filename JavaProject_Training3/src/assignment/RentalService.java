...
public class RentalService implements RentalCostCalculator {
	...
	// Rent a vehicle
	public Rental rentVehicle(Customer customer, Vehicle vehicle, LocalDateTime startDate, LocalDateTime endDate) {
	...
	// Calculate rental cost
	 @Override
	    public BigDecimal calculateRentalCost(Rental rental) {
	        LocalDateTime startTime = rental.getStartDate();
	        LocalDateTime endTime = rental.getEndDate();
